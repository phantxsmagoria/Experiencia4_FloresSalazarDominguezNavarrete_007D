...
from .views import index, vision, mision, quienessomos, formulario, adoptados, galeria, registrousuario, compras, mod_registrousuario, mostrardatos, del_registrousuario
